  ...
  return (
    <>
      <div>
        ...
        <InputLabel id="employee-resume">Emp. Name</InputLabel>
        <Select
          labelId="employee-resume"
          id="employee-resume-filled"
          value={employeeName}
        ...
        >
          ...
          <MenuItem value={1}>Shivam Bhalla</MenuItem>
          <MenuItem value={2}>Deepanshu Bansal</MenuItem>
          <MenuItem value={3}>Pragya Chandak</MenuItem>
        </Select>
        </FormControl>
        <Button className={classes.saveButton} variant="contained" color="primary">Download</Button>
        </div>
          ...
          <TableBody>
            ...
            <>
              <StyledTableRow key={index}>
                ...
                <TableCell className={classes.collapseCol}>
                <EditIcon edge="start" aria-label="close" id={index} onClick={()=>{
                    return editProblemSolvedArray(index);
                  }}></EditIcon>
                </TableCell>
                <TableCell className={classes.collapseCol}>
                  <CancelIcon edge="start" aria-label="close" id={index} onClick={()=>{
      ...
      <CardContent>
        ...
        <div>
        <div className={classes.projectAddButton}></div>
...
ManagerResumeView.propTypes = {};

export default memo(ManagerResumeView);
